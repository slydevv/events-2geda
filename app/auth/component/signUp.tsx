...
import { SignupFormInputs, signinFormSchema } from "@/app/types/index";
...
export default function SignUp() {
  ...
  return (
    <section data-test="form-header" className="">
      <Header title="Welcome! Sign up for free" />
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex flex-col mt-14 items-center space-y-4">
            ...
            <p>
              ...
              <span
                className="inline-block text-bluemedium underline underline-offset-4 hover:text-bluestrong ml-2"
                onClick={() =>
                  dispatch(changeAuthDisplay(AuthScreenDisplay.signIn))
                }
              >
                Sign In
              </span>
